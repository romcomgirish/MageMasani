...
class CustomerLoginObserver implements ObserverInterface
{
    ...
    /**
     * Send 'login' push notification on customer login
     *
    ...
    public function execute(Observer $observer): void
    {
        ...
        $campaigns = $this->campaignMatcher->getMatchingCampaigns('login');
        ...
        foreach ($campaigns as $campaign) {
            try {
                ...
                $this->logger->error(
                    'PushNotification: Failed to send login notification',
                    [
