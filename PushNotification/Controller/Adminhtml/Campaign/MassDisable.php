...
class MassDisable extends Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($itemsSaved) {
                $this->messageManager->addSuccessMessage(__('%1 Campaign(s) disabled', $itemsSaved));
            }
        } catch (LocalizedException $e) {
            $this->messageManager->addErrorMessage(__($e->getMessage()));
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage(__('An error occurred while disabling selected campaigns: %1', $e->getMessage()));
        }
